...
let totalQuantite = new Array();
let totalPrix = new Array();
...
Panier.forEach((element) => {
  ...
  let quantite = parseInt(element.quantite);//totalquantite+ prix element
  let prix = parseInt(infoJson.price * element.quantite); //totalprix + prix element
  ...
  sumQuantite =totalQuantite.reduce(reducer,0);//total des quantités
  sumPrix =totalPrix.reduce(reducer,0);//prix total
